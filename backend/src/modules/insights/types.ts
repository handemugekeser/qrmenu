...
export type ProductWithTranslations = Product & { translations?: Translation[] };
export type CategoryWithProducts = Category & {
  products?: ProductWithTranslations[];
  translations?: Translation[];
};
export type MenuWithContent = Menu & { categories?: CategoryWithProducts[] };
...
export interface EventAggregates {
  ...
  itemDwellMs: Record<string, { avgMs: number; samples: number }>;
