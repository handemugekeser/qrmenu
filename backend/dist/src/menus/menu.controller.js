...
let MenuController = class MenuController {
    ...
    create(businessId, userId, dto) {
        return this.menuService.create(businessId, userId, dto);
    }
    findAll(businessId, userId) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String, menu_service_1.CreateMenuDto]),
...
__decorate([
    ...
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, menu_service_1.UpdateMenuDto]),
    __metadata("design:returntype", void 0)
...
exports.MenuController = MenuController = __decorate([
    (0, common_1.Controller)('businesses/:businessId/menus'),
